...
export const mockServices: Service[] = [
  ...
  },
  {
    ...
    duration: 120,
    price: 5000,
    description: "Однотонное окрашивание профессиональной краской",
  ...
  },
  {
    ...
    duration: 90,
    price: 2800,
    description: "Маникюр с художественным дизайном ногтей",
  ...
  },
  {
    ...
    duration: 90,
    price: 3500,
    description: "Ультразвуковая чистка лица",
  ...
  },
  {
    ...
    duration: 120,
    price: 4000,
    description: "Поресничное наращивание, эффект 2D",
    image: "https://images.unsplash.com/photo-1633465631144-aa321b66d44a?w=400&h=300&fit=crop",
  },
  {
    id: 10,
...
export function getMockServiceById(serviceId: number): Service | null {
  return mockServices.find((service) => service.id === serviceId) ?? null;
}

export function getMockMasterById(masterId: number): Master | null {
  return mockMasters.find((master) => master.id === masterId) ?? null;
}

export function getMockSlots(): TimeSlot[] {
